...
#define SIMON_DASH_SPEED		0.2f
#define SIMON_DASH_DURATION		300
#define SIMON_DASH_CD			600


#define SIMON_GRAVITY			0.002f //0.002f
...
#define SIMON_STATE_DASH			800

#define SIMON_SHURIKEN				900
...
#define ID_ANI_SIMON_SIT_A TTACK_LEFT    2801
...
protected:
	...
	bool isDashing = false;  // Kiểm tra Simon có đang Dash không
    int dashTime = 0, dashCD;      // Thời gian Dash còn lại

	
public:
	int ShurikenTime = SHURIKEN_LIVE_TIME;

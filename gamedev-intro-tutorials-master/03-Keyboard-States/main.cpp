...
void LoadResources()
{
...

	{
		...
		//WEAPON SHURIKEN
		sprites->Add(20301, 1147, 478, 1161, 491, texSimon);
		sprites->Add(20302, 1165, 478, 1179, 491, texSimon);
		sprites->Add(20303, 1182, 478, 1195, 491, texSimon);

		ani = new CAnimation(100);
		ani->Add(20301);
		ani->Add(20302);
		ani->Add(20303);
		animations->Add(ID_ANI_SHURIKEN, ani);
		objects.push_back(new CShuriken(SIMON_START_X, SIMON_START_Y));
	}
}
